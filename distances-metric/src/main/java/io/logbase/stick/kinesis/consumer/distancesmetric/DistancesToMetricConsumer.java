...
public class DistancesToMetricConsumer {

  private static final Log LOG = LogFactory.getLog(DistancesToMetricConsumer.class);
  public static final String STREAM_NAME = "stick-distances";
  private static final String CONSUMER_NAME = "DistancesToMetricConsumer";

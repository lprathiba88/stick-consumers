...
public class LocationsToStorageConsumer {

  private static final Log LOG = LogFactory.getLog(LocationsToStorageConsumer.class);
  public static final String STREAM_NAME = "stick-locations";
  private static final String CONSUMER_NAME = "LocationsToStorageConsumer";
